...
local common_spawn_chance = 20000-- tonumber(minetest.settings:get("animalia_common_chance")) or 60000

local ambient_spawn_chance = 9000 --tonumber(minetest.settings:get("animalia_ambient_chance")) or 9000

local pest_spawn_chance = tonumber(minetest.settings:get("animalia_pest_chance")) or 3000

local predator_spawn_chance = 30000--tonumber(minetest.settings:get("animalia_predator_chance")) or 45000
